export const appointmentCompletedEmailForAdvisor = (
  advisorName: string,
  subject: string,
          ...
          <tbody>
            <tr style="vertical-align: top">
              <td
                ...
                "
              >
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #f8f5fc;"><![endif]-->
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://firebasestorage.googleapis.com/v0/b/pae-files-bucket/o/Copia_de_PAE_Logo.png?alt=media&token=5e4c0102-9d58-4684-af91-b079b18d992c"
                                            alt=""
                                            title=""
                                            style="
                                              outline: none;
                                      ...
                                      <p style="font-size: 14px; line-height: 190%">
                                        <span
                                          style="
                                            ...
                                            line-height: 30.4px;
                                          "
                                          >Impartiste recientemente una asesor&iacute;a
                                          de ${subject}. Muchas gracias por dedicar tu tiempo para compartir tu conocimiento con lxs demás.<br
                                        /><br/>Te pedimos contestes una breve encuesta para que continuemos mejorando nuestro servicio. ¡Gracias por confiar en PAE!</span>
                                      </p>
                                    </div>
                                  </td>
                                </tr>
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://firebasestorage.googleapis.com/v0/b/pae-files-bucket/o/barbilla.png?alt=media&token=ba0a37e9-b1ce-4a13-b5fb-66d2e2acb7c4"
                                            alt="border"
                                            title="border"
                                            style="
                                              outline: none;
